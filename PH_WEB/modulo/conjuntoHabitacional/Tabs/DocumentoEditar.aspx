<%@ Page UICulture="es" Culture="es-cl" Language="C#" MasterPageFile="~/modulo/conjuntoHabitacional/Tabs/MarcoTab.master" AutoEventWireup="true" CodeFile="DocumentoEditar.aspx.cs" Inherits="modulo_conjuntoHabitacional_Tabs_DocumentoEditar" %>
...
<legend>Agregar Nuevo Documento</legend>
   ...
   <tr>
    ...
    <tr>
        ...
        <span id="divArchivo" runat="server"></span>
        </td>
    </tr>
</table>    
