<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductoLocalComercialVisualizar.aspx.cs" 
...
<h1>VISUALIZACION LOCAL COMERCIAL</h1>
...
<table border="1" cellpadding="0" cellspacing="0" style="margin: 0 0 15px 0;">
    <tr>
        <td align="left" valign="middle">Sitio:<br/>
            <asp:TextBox ID="text_sitio" runat="server" ReadOnly="true"></asp:TextBox>
        </td>
    </tr>
</table>
...
<table>
    <tr>
        <td colspan="3">Característica:<br /><textarea rows="5" class="input-xxlarge" id="text_caracteristicas" runat="server" disabled></textarea></td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">Total Mts2 Construido (EJ: 70,43):<br/>
            <asp:TextBox ID="text_mConstruido" runat="server" width="80" ReadOnly="true"></asp:TextBox>
        </td>
        <td align="left" valign="middle">Total Mts2 Terreno (Ej: 100,23):<br/>
            <asp:TextBox ID="text_mTerreno" runat="server" width="80" ReadOnly="true"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td align="left" valign="middle">Dirección Comunal:<br/>
            <asp:TextBox ID="text_direccionComunal" runat="server" width="120" ReadOnly="true"></asp:TextBox>
        </td>
        <td align="left" valign="middle">Rol SII:<br/>
            <asp:TextBox ID="text_rolSII" runat="server" width="80" ReadOnly="true"></asp:TextBox>
        </td>
