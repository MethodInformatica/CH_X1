<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/modulo/conjuntoHabitacional/Tabs/MarcoTab.master" CodeFile="ProductoCasaVisualizar.aspx.cs" Inherits="modulo_conjuntoHabitacional_Tabs_ProductoCasa" %>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="90%">
        <tr>
            <td align="left" valign="middle">Manzana:<br/>
                <asp:TextBox ID="text_manzana" runat="server" Width="120" ReadOnly="true"></asp:TextBox>
            </td>
            <td align="left" valign="middle">Sitio:<br/>
	            <asp:TextBox ID="text_sitio" runat="server" Width="120" ReadOnly="true"></asp:TextBox>
            </td>
            <td align="left" valign="middle">Casa Esquina:<br/>
	            <asp:DropDownList ID="ddlCasaEsquina" runat="server" class="input-medium" Enabled="false">
            ...
            <td align="left" valign="middle">Modelo:<br/>
	            <asp:TextBox ID="text_modelo" runat="server" Width="120" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
    </table>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="90%">
        <tr>
            ...
            <td align="left" valign="middle" colspan="2">Dirección:<br/>
	            <asp:TextBox ID="text_direccion" runat="server" width="300" ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
        <tr><td colspan="4">&nbsp</td></tr>
        <tr>
            <td align="left" valign="middle">Total Mts2 Construido (EJ: 70,43):<br/>
                <asp:TextBox ID="text_mConstruido" runat="server" width="100" ReadOnly="true"></asp:TextBox>
            </td>
